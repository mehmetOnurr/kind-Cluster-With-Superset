...
SQLALCHEMY_DATABASE_URI = (
    f"postgresql+psycopg2://superset:superset@superset-postgresql:5432/superset"
)
...
# 🔐 Statik Güvenlik ve Geliştirme Ayarların
SECRET_KEY = "djAJakz61TC4UeYoODAKFiQlgb0jS85Ro2CFz6AY3ws="
